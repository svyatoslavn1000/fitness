...
public class SportTypeServiceImpl implements SportTypeService {
    ...
    @Override
    public SportTypeDto getById(Short id) {
    ...
    @Override
    @Transactional
    public SportTypeDto save(SportTypeDto sportTypeRqDto) {
    ...
    @Override
    @Transactional
    public SportTypeDto update(Short id, SportTypeDto sportTypeRqDto) {
